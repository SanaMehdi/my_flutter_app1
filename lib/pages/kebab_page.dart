                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context, '/details',
                              arguments: {'image': 'assets/images/Kebab11.png'});
                        },
                        child: _buildThumbnail('assets/images/Kebab11.png'),
                      ),
                      SizedBox(height: 10),
                      _buildThumbnail('assets/images/Kebab22.png'),
                      SizedBox(height: 10),
                      _buildThumbnail('assets/images/Kebab33.png'),
                      SizedBox(height: 10),
                      _buildThumbnail('assets/images/Kebab44.png'),
                    ],
                  ),
                ],
              ),
